...
{
    [AllowAnonymous]
    public static async Task<IResult> HandleAsync(string email, IAccountRepository repository, TokenService tokenService, IEmailService emailService, CancellationToken stoppingToken)
    {
